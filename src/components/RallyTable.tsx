...
const RallyTable: React.FC = () => {
    ...
    return (
        <div className="w-full p-4 md:p-8 font-sans dark:bg-gray-950 dark:text-gray-100 min-h-screen">
                ...
                <div className="overflow-x-auto shadow-lg rounded-xl border border-gray-700">
                    <table className="min-w-full divide-y divide-gray-700">
                        <thead className="bg-gray-800">
                            <tr>
                                <th className="px-1 py-3 text-center text-[10px] md:text-xs font-medium text-gray-400 uppercase tracking-wider">
                                    Piloto
                                </th>
                                <th className="px-1 py-3 text-center text-[10px] md:text-xs font-medium text-gray-400 uppercase tracking-wider">
                                    Cat.
                                ...
                                {columns.map((column) => (
                                    <th key={column.id} className="px-1 py-3 text-center text-[10px] md:text-xs font-medium text-gray-400 uppercase tracking-wider">
                                        {column.label}
                                    </th>
                                ))}
                                <th className="px-1 py-3 text-center text-[10px] md:text-xs font-medium text-gray-400 uppercase tracking-wider">
