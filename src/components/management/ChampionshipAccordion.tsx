        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
          {championships.map(camp => (
            <div
              ...
              className="bg-[#09090b] border border-zinc-800 hover:border-zinc-700 shadow-sm group/camp cursor-pointer transition-transform hover:scale-[1.02] active:scale-[0.98] rounded-xl overflow-hidden"
              role="button"
              tabIndex={0}
            >
              <div className="p-5 flex flex-col gap-3 h-full">
                ...
                <div className="mt-auto pt-3 border-t border-zinc-800/50">
                  <Chip size="sm" className="bg-zinc-800 text-zinc-300 border border-zinc-800 text-xs rounded-md">
          ...
          <div key={camp.id} className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className="text-zinc-400 hover:text-zinc-100 bg-transparent hover:bg-zinc-800/50"
              >
            ...
            {/* Championship card */}
            <Card className="bg-[#09090b] border border-zinc-800 shadow-sm">
              <CardBody className="p-5 md:p-7">
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-zinc-800/60">
                  ...
                  <Button
                    ...
                    className="bg-zinc-800 text-zinc-100 hover:bg-zinc-700 font-medium rounded-md"
                  >
                ...
                <div className="flex flex-col gap-3">
                  {rallies.filter(r => r.championship_id === camp.id).length === 0 ? (
                    ...
                    rallies.filter(r => r.championship_id === camp.id).map(rally => (
                      <div key={rally.id} className="bg-[#09090b] border border-zinc-800 rounded-lg overflow-hidden flex flex-col">
                        {/* Rally header row */}
                        <div
                          className="p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-colors group/rally"
                        >
                          <div className="flex items-center gap-3">
                            <div className="bg-zinc-800 p-2 rounded-md shadow-sm">
                          ...
                          <div className="flex items-center gap-2 w-full sm:w-auto">
                            <Button
                              className="font-medium text-sm px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md w-full sm:w-auto shadow-none min-w-0"
                              onPress={() => navigate(`/gestion-rally/${rally.id}`)}
                            >
                              Configurar Rally
                            </Button>
                            <button
